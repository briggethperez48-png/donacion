...
<body>
    ...
    <footer class="footer position-fixed">
        <!-- <div class="d-flex mb-1">
            <div class="redes justify-content-between">
        ...
        <div class="priv text-left mb-1" style="line-height: 0.9;">
            ...
            <a href="http://data.salud.cdmx.gob.mx/ssdf/portalut/archivo/Actualizaciones/HOSPITALES/57-57.pdf" target="_blank" rel="noopener noreferrer" style="font-size: 11px;">
                <b>http://data.salud.cdmx.gob.mx/ssdf/portalut/archivo/Actualizaciones/HOSPITALES/57-57.pdf</b>
            </a>
        </div>
