    ...
    <form action="{{url('/donador')}}" method="POST" enctype="multipart/form-data" class="m-3">
        ...
        <fieldset class="card mb-4 shadow-sm border-light">
            ...
            <div class="card-body Donador">
                ...
                <div id="seccion-organos" class="mt-4 p-3 bg-light rounded border-left border-secondary" style="display: none;">
        ...
        <div class="mb-5 text-center">
            <button type="submit" class="btn btn-success btn-lg px-5 shadow">Guardar Registro</button>
        </div>
    </form>
</div>
    @section('scripts')
